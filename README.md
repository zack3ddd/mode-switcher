...
> 概念參考自 MACHIN3tools，由 Zack3D 製作（AI 協助）。

## 功能

- **TAB 餅選單切換模式**：物件／編輯／雕刻／各種繪製／姿勢／蠟筆模式都能快速切換
...
- 對應 Blender 4.3 以上／5.2 LTS

## 致謝與授權

概念參考 [MACHIN3tools](https://github.com/machin3io/MACHIN3tools)。作者：Zack3D。以 GNU GPL 釋出。
